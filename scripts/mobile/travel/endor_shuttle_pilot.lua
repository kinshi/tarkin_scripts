endor_shuttle_pilot = Creature:new {
  ...
  lootGroups = {},
  weapons = {},
  conversationTemplate = "endorshuttlepilot_template",
  attacks = {
  }
}

CreatureTemplates:addCreatureTemplate(endor_shuttle_pilot, "endor_shuttle_pilot")
