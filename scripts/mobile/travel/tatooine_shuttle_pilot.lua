tatooine_shuttle_pilot = Creature:new {
  ...
  lootGroups = {},
  weapons = {},
  conversationTemplate = "tatooineshuttlepilot_template",
  attacks = {
  }
}

CreatureTemplates:addCreatureTemplate(tatooine_shuttle_pilot, "tatooine_shuttle_pilot")
