dantooine_shuttle_pilot = Creature:new {
  ...
  lootGroups = {},
  weapons = {},
  conversationTemplate = "dantooineshuttlepilot_template",
  attacks = {
  }
}

CreatureTemplates:addCreatureTemplate(dantooine_shuttle_pilot, "dantooine_shuttle_pilot")
