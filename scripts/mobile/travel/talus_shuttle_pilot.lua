talus_shuttle_pilot = Creature:new {
  ...
  lootGroups = {},
  weapons = {},
  conversationTemplate = "talusshuttlepilot_template",
  attacks = {
  }
}

CreatureTemplates:addCreatureTemplate(talus_shuttle_pilot, "talus_shuttle_pilot")
