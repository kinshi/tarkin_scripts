rori_shuttle_pilot = Creature:new {
  ...
  lootGroups = {},
  weapons = {},
  conversationTemplate = "rorishuttlepilot_template",
  attacks = {
  }
}

CreatureTemplates:addCreatureTemplate(rori_shuttle_pilot, "rori_shuttle_pilot")
