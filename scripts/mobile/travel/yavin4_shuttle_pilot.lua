yavin4_shuttle_pilot = Creature:new {
  ...
  lootGroups = {},
  weapons = {},
  conversationTemplate = "yavin4shuttlepilot_template",
  attacks = {
  }
}

CreatureTemplates:addCreatureTemplate(yavin4_shuttle_pilot, "yavin4_shuttle_pilot")
