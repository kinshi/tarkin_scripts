naboo_shuttle_pilot = Creature:new {
  ...
  lootGroups = {},
  weapons = {},
  conversationTemplate = "nabooshuttlepilot_template",
  attacks = {
  }
}

CreatureTemplates:addCreatureTemplate(naboo_shuttle_pilot, "naboo_shuttle_pilot")
