nightsister_protector_trick = Creature:new {
	...
	conversationTemplate = "trick_convo_template",
	attacks = merge(tkamaster,brawlermaster,fencermaster,forcepowermaster)
}

CreatureTemplates:addCreatureTemplate(nightsister_protector_trick, "nightsister_protector_trick")
