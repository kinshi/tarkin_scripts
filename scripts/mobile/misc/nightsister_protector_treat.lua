nightsister_protector_treat = Creature:new {
	objectName = "@mob/creature_names:nightsister_protector",
	customName = "\\#ee3377Trick or Treat?",
	...
	conversationTemplate = "treat_convo_template",
	attacks = merge(tkamaster,brawlermaster,fencermaster,forcepowermaster)
}

CreatureTemplates:addCreatureTemplate(nightsister_protector_treat, "nightsister_protector_treat")
