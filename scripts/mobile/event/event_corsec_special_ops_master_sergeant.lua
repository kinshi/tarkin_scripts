event_corsec_special_ops_master_sergeant = Creature:new {
...
CreatureTemplates:addCreatureTemplate(event_corsec_special_ops_master_sergeant, "event_corsec_special_ops_master_sergeant")
