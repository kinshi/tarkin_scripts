...
veteranRewardMilestones = {90, 180, 270, 360} --days, must be sorted low to high
...
veteranRewards = {
	...
	{templateFile = "object/tangible/deed/player_house_deed/vipbunker_house_deed.iff", milestone=360, oneTime=false, description="VIP Bunker"},
