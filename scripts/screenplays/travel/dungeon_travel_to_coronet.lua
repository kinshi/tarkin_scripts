...
function DungeonTravelToCoronetScreenPlay:spawnSceneObjects()
   ...
   spawnSceneObject("endor", "object/ship/hutt_medium_s01_tier1.iff", -4675, 16.3, 4312, 0, 0.55096, 0, 0.834531, 0)
   -- Geo Cave (Yavin4)
   spawnSceneObject("yavin4", "object/ship/hutt_medium_s01_tier1.iff", -6490, 87.3, -434, 0, 0.55096, 0, 0.834531, 0)
   -- Lord Nyax (Corellia)
   spawnSceneObject("corellia", "object/ship/hutt_medium_s01_tier1.iff", 1289, 31.3, -303, 0, 0.55096, 0, 0.834531, 0)
   -- Fort Tusken (Tatooine)
   spawnSceneObject("tatooine", "object/ship/hutt_medium_s01_tier1.iff", -3916, 29.3, 6355, 0, 0.55096, 0, 0.834531, 0)
   ...
   spawnSceneObject("dantooine", "object/ship/hutt_medium_s01_tier1.iff", -541, 4.3, -3810, 0, 0.55096, 0, 0.834531, 0)
   -- Droid Cave (Lok)
   spawnSceneObject("lok", "object/ship/hutt_medium_s01_tier1.iff", 3480, 15.3, -5030, 0, 0.55096, 0, 0.834531, 0)
...
function DungeonTravelToCoronetScreenPlay:spawnMobiles()
  -- Placing Wolten Kinhara
   ...
   -- Death Watch Bunker (Endor)
   local pPilot1 = spawnMobile("endor", "wolten_kinhara_to_coronet", 1, -4677, 13, 4319, 42, 0)  
   -- Geo Cave (Yavin4)
   local pPilot2 = spawnMobile("yavin4", "wolten_kinhara_to_coronet", 1, -6492, 84, -427, 42, 0)
   -- Lord Nyax (Corellia)
   local pPilot3 = spawnMobile("corellia", "wolten_kinhara_to_coronet", 1, 1287, 28, -296, 42, 0)
   -- Fort Tusken (Tatooine)
   local pPilot4 = spawnMobile("tatooine", "wolten_kinhara_to_coronet", 1, -3918, 26, 6362, 42, 0)
   -- Janta Cave (Dantooine)
   local pPilot5 = spawnMobile("dantooine", "wolten_kinhara_to_coronet", 1, 7037, 46, -4074, 42, 0) 
   -- The Warren (Dantooine)
   local pPilot6= spawnMobile("dantooine", "wolten_kinhara_to_coronet", 1, -543, 1, -3803, 42, 0)
   -- Droid Cave (Lok)
