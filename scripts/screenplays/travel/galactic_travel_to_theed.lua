...
function GalacticTravelToTheedScreenPlay:spawnMobiles()
  ...
  local pPilotDantooine = spawnMobile("dantooine", "star_pilot_to_theed", 1, -646.486, 3, 2487.45, 0, 0)
  local pPilotDathomir = spawnMobile("dathomir", "star_pilot_to_theed", 1, 596.496, 6, 3099.35, 0, 0)
  local pPilotEndor = spawnMobile("endor", "star_pilot_to_theed", 1, -970.212, 73, 1564.25, 0, 0)
  local pPilotLok = spawnMobile("lok", "star_pilot_to_theed", 1, 455.647, 8.74727, 5506.7, 0, 0)
  ...
  local pPilotYavin = spawnMobile("yavin4", "star_pilot_to_theed", 1, -6926.93, 73, -5703.08, 0, 0)  
