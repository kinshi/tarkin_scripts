...
function planetarytravel_convo_handler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)
    ...
    player:switchZone("naboo", -4976, 0, 4103, -90)
  elseif (screenID == "theed_palace") then
    player:switchZone("naboo", -5411, 0, 4320, -90)
  elseif (screenID == "theed_west") then
    player:switchZone("naboo", -5858, 0, 4171, -90)
  elseif (screenID == "lake_retreat") then
    player:switchZone("naboo", -5492, -150, -22, -94)
  elseif (screenID == "keren_west") then
    player:switchZone("naboo", 1567, 25, 2840, 160)
  elseif (screenID == "keren_east") then
    player:switchZone("naboo", 2021, 19, 2526, -61)
  elseif (screenID == "kaadara") then
    player:switchZone("naboo", 5124, -192, 6615, 42)
  elseif (screenID == "deeja_peak") then
    player:switchZone("naboo", 5329, 326, -1574, -87)
  elseif (screenID == "moenia") then
    player:switchZone("naboo", 4960, 3, -4893, -44)
  end
