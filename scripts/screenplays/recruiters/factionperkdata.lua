...
faction_reward_data = {
	...
	imperial_installations = {
		at_st_house = {type=faction_reward_type.installation, display="AT-ST House Schematic", item="object/draft_schematic/structure/atat_house_schem.iff", cost=10000},
	...
	rebel_installations = {
		rebel_spire_house = {type=faction_reward_type.installation, display="Rebel Spire House Schematic", item="object/draft_schematic/structure/rebel_house_schem.iff", cost=10000},
