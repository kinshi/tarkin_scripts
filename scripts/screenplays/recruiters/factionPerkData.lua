...
rebelRewardData = {
	...
	weaponsArmor = {
		...
		armor_rebel_commando_helmet = { type=faction_reward_type.armor, display="@wearables_name:Rebel Commando Helmet", item="object/tangible/wearables/helmet/helmet_s06.iff", cost=3000},
	},
