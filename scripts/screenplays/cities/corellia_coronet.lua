...
function CorelliaCoronetScreenPlay:spawnSceneObjects()
  ...
  createObserver(OBJECTRADIALUSED, "CorelliaCoronetScreenPlay", "teleportWarren", pCollector6)
  ...
  createObserver(OBJECTRADIALUSED, "CorelliaCoronetScreenPlay", "teleportDroidCave", pCollector7)
...
function CorelliaCoronetScreenPlay:teleportWarren(pCollector6, pPlayer)
  local player = LuaSceneObject(pPlayer)
  player:switchZone("dantooine", -618, 0, -3738, -90)
  return 0
end

function CorelliaCoronetScreenPlay:teleportDroidCave(pCollector7, pPlayer)
  local player = LuaSceneObject(pPlayer)
