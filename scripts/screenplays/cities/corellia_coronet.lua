...
--	spawnMobile("corellia", "trainer_imagedesigner",0,-21.4483,2.12878,74.4461,185,2365400)
	...
	spawnMobile("corellia", "corsec_security_specialist",400,-593.7,28,-4322,-98,0)
	spawnMobile("corellia", "corsec_security_specialist",400,-547.3,28,-4668.3,151,0)
	spawnMobile("corellia", "corsec_security_specialist",400,141,28,-4692.8,76,0)
	spawnMobile("corellia", "corsec_security_specialist",400,100.5,28,-4668.1,-127,0)
	spawnMobile("corellia", "corsec_security_specialist",400,-192.6,28,-4833.5,134,0)
	spawnMobile("corellia", "corsec_security_specialist",400,-201.2,28.6,-4122,20.0006,0)
	...
	spawnMobile("corellia", "trooper",400,-275.4,28,-4614.6,256.27,0)
