...
--Shuttle A
spawnSceneObject("naboo", "object/creature/npc/theme_park/player_shuttle.iff", -5875, 6.0, 4170, 0, 0)

--Shuttle B
spawnSceneObject("naboo", "object/creature/npc/theme_park/player_shuttle.iff", -4989, 6.0, 4090, 0, 50)

--Shuttle C
spawnSceneObject("naboo", "object/creature/npc/theme_park/player_shuttle.iff", -5411, 6.0, 4302, 0, 80)
...
function NabooTheedScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "rsf_security_guard",400,-5206.32,6,4182.8,329.254,0)
	spawnMobile("naboo", "rsf_security_guard",400,-4800,6,4113,121.097,0)
	spawnMobile("naboo", "rsf_security_guard",400,-5126.48,6.52214,4130.79,184.164,0)
	spawnMobile("naboo", "rsf_security_guard",400,-5132.44,6,4087.27,158.596,0)
	spawnMobile("naboo", "rsf_security_guard",400,-5016.16,6,4107,226.021,0)
	spawnMobile("naboo", "rsf_security_guard",400,-4848.1,6.55806,4172.25,222.445,0)
	spawnMobile("naboo", "rsf_security_guard",400,-4933.43,6,4233.84,32.6463,0)
	spawnMobile("naboo", "rsf_security_guard",400,-4857.84,6.43289,4178.31,222.445,0)
	--{"stormtrooper_groupleader",400,-5969.83,6,4246.76,173.432,0, "", "VK-481"},
	spawnMobile("naboo", "rsf_security_guard",400,-5160.99,6.52214,4159.54,216.801,0)
	spawnMobile("naboo", "rsf_security_guard",400,-4845.17,6.43094,4167.68,222.445,0)
...
--	spawnMobile("naboo", "trainer_weaponsmith",0,-3.1,1.1,-8.2,91,1692094)
	...
	spawnMobile("naboo", "rsf_security_guard",300,16.6641,1.28309,-2.37071,180.007,1677395)
