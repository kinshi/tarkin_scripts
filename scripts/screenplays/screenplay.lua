...
-- To-do Naboo Emporers Retreat, Bestine & Imperial Oasis/Tatooine
...
-- to-do Corellia, separate screenplay for rebel hideout, Leias Base/Lok, Anchorhead/Tatooine,  Rebel Base/Dantooine
