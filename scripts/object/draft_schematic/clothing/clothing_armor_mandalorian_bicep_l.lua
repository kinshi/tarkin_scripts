...
object_draft_schematic_clothing_clothing_armor_mandalorian_bicep_l = object_draft_schematic_clothing_shared_clothing_armor_mandalorian_bicep_l:new {
  templateType = DRAFTSCHEMATIC,
   ...
   resourceTypes = {"armophous_vendusii", "fuel_petrochem_solid_known", "fiberplast_talus", "aluminum_chromium", "copper_platinite", "hide_wooly_rori", "object/tangible/component/armor/armor_segment_ris_acklay.iff", "object/tangible/dungeon/death_watch_bunker/gel_packet.iff", "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_bicep_l.iff"},
