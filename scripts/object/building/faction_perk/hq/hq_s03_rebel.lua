...
--Tarkin GCW NPCs
	childCreatureObjects = {
		 	{ mobile="gcw_rebel_defence_droid", x=35, z=0, y=32, cellid=-1, respawn=600, containmentType=-1, heading=3.14},
		 	{ mobile="gcw_rebel_defence_droid", x=-35, z=0, y=32, cellid=-1, respawn=600, containmentType=-1, heading=0},
		 	{ mobile="gcw_specforce_marine", x=10, z=0, y=4, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	{ mobile="gcw_rebel_specforce_urban_guerrilla", x=10, z=0, y=10, cellid=-1, respawn=360, containmentType=-1, heading=0},

		 	{ mobile="gcw_specforce_marine", x=-10, z=0, y=4, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	{ mobile="gcw_rebel_specforce_urban_guerrilla", x=-10, z=0, y=10, cellid=-1, respawn=360, containmentType=-1, heading=0},

			{ mobile="gcw_rebel_specforce_urban_guerrilla", x=8, z=0, y=20, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_specforce_urban_guerrilla", x=-8, z=0, y=20, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_specforce_pathfinder", x=12, z=0, y=17, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_specforce_pathfinder", x=-12, z=0, y=17, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="gcw_specforce_marine", x=-28, z=0, y=0, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_specforce_marine", x=-33, z=0, y=0, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	{ mobile="gcw_rebel_trooper", x=-30.5, z=0, y=2.5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_commando", x=-28, z=0, y=5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_medic", x=-33, z=0, y=5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="gcw_rebel_medic", x=33, z=0, y=5, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	...
		 	{ mobile="gcw_rebel_trooper", x=-24.5, z=0, y=34.5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_commando", x=-22, z=0, y=37, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_medic", x=-27, z=0, y=37, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="gcw_rebel_corporal", x=-4.5, z=0, y=-2, cellid=2, respawn=300, containmentType=-1, heading=4.71},
			{ mobile="gcw_rebel_corporal", x=-4.5, z=0, y=0.9, cellid=2, respawn=300, containmentType=-1, heading=4.71},

			{ mobile="gcw_specforce_marine", x=4, z=-3.25, y=5, cellid=4, respawn=300, containmentType=-1, heading=3.14},

		 	{ mobile="gcw_specforce_marine", x=-5, z=-10.25, y=-6, cellid=5, respawn=300, containmentType=-1, heading=0},

			{ mobile="gcw_specforce_marine", x=-2.7, z=-13.75, y=7, cellid=7, respawn=300, containmentType=-1, heading=1.57},
			{ mobile="gcw_specforce_marine", x=-5, z=-13.75, y=7, cellid=7, respawn=300, containmentType=-1, heading=1.57},

			{ mobile="gcw_rebel_first_lieutenant", x=-1.85, z=-20.75, y=5.1, cellid=9, respawn=300, containmentType=-1, heading=4.71},
			{ mobile="gcw_specforce_lieutenant", x=4.6, z=-20.75, y=5.1, cellid=9, respawn=300, containmentType=-1, heading=1.57},

			{ mobile="gcw_specforce_marine", x=-1, z=-20.75, y=16, cellid=10, containmentType=-1, respawn=300, heading=1.57},
 			{ mobile="gcw_specforce_marine", x=-3.5, z=-20.75, y=23, cellid=10, containmentType=-1, respawn=300, heading=1.57},
			{ mobile="gcw_specforce_marine", x=5, z=-20.75, y=16, cellid=10, containmentType=-1, respawn=300, heading=4.71},
 			{ mobile="gcw_specforce_marine", x=6.5, z=-20.75, y=23, cellid=10, containmentType=-1, respawn=300, heading=4.71},
			{ mobile="gcw_specops_agent", x=2.6, z=-20.75, y=29.9, cellid=10, containmentType=-1, respawn=300, heading=3.14},
			{ mobile="gcw_rebel_coordinator", x=0.6, z=-20.75, y=29.9, cellid=10, containmentType=-1, respawn=300, heading=3.14},
			{ mobile="gcw_specforce_major", x=5.8, z=-20.75, y=29.9, cellid=10, containmentType=-1, respawn=300, heading=4.71},
			{ mobile="gcw_rebel_commander", x=5.5, z=-20.75, y=35, cellid=10, containmentType=-1, respawn=600, heading=3.14},
