...
--Tarkin GCW NPCs
		childCreatureObjects = {
			{ mobile="gcw_rebel_defence_droid", x=0, z=0, y=42, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="gcw_specforce_marine", x=0, z=0, y=32.5, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="gcw_specforce_heavy_weapons_specialist", x=-2.5, z=0, y=30, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_sergeant", x=2.5, z=0, y=30, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_medic", x=-2.5, z=0, y=35, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="gcw_rebel_commando", x=2.5, z=0, y=35, cellid=-1, respawn=300, containmentType=-1, heading=0},

			{ mobile="gcw_specforce_marine", x=27, z=0, y=12, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="gcw_specforce_heavy_weapons_specialist", x=32, z=0, y=12, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_sergeant", x=29.5, z=0, y=14.5, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_medic", x=27, z=0, y=17, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="gcw_rebel_commando", x=32, z=0, y=17, cellid=-1, respawn=300, containmentType=-1, heading=0},
			...
			{ mobile="gcw_specforce_marine", x=-9, z=0, y=10, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_specforce_marine", x=9, z=0, y=10, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_specforce_marine", x=-2, z=0, y=10, cellid=-1, respawn=300, containmentType=-1, heading=0},

			{ mobile="gcw_rebel_first_lieutenant", x=3.6, z=0, y=1.8, cellid=4, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_rebel_medic", x=-3.8, z=0, y=-2.3, cellid=6, respawn=300, containmentType=-1, heading=0},
