...
--Tarkin GCW NPCs
			childCreatureObjects = {
		 	{ mobile="gcw_at_st", x=0, z=0, y=52, cellid=-1, respawn=720, containmentType=-1, heading=0},
		 	{ mobile="gcw_dark_trooper", x=0, z=0, y=60, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=5, z=0, y=60, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=-5, z=0, y=60, cellid=-1, respawn=360, containmentType=-1, heading=0},

			{ mobile="gcw_dark_trooper", x=25, z=0, y=-13, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="gcw_stormtrooper_squad_leader", x=30, z=0, y=-13, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper", x=27.5, z=0, y=-10.5, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_medic", x=25, z=0, y=-8, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="gcw_stormtrooper_bombardier", x=30, z=0, y=-8, cellid=-1, respawn=300, containmentType=-1, heading=0},
			...
			{ mobile="gcw_stormtrooper", x=0, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper", x=-4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	{ mobile="gcw_stormtrooper", x=4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_bombardier", x=2, z=0, y=19, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_medic", x=-2, z=0, y=19, cellid=-1, respawn=360, containmentType=-1, heading=0},

		 	{ mobile="gcw_stormtrooper_squad_leader", x=-30, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_medic", x=-25, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_colonel", x=-27.5, z=0, y=28.5, cellid=-1, respawn=360, containmentType=-1, heading=0},

			{ mobile="gcw_stormtrooper", x=25, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	{ mobile="gcw_stormtrooper", x=30, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_bombardier", x=27.5, z=0, y=28.5, cellid=-1, respawn=360, containmentType=-1, heading=0},
	
			{ mobile="gcw_imperial_trooper", x=2.6, z=0, y=-4.1, cellid=3, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=-6.7, z=-6.75, y=-0.8, cellid=5, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=-0.1, z=-6.75, y=-6.3, cellid=5, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_medic", x=9.3, z=-6.75, y=-15.0, cellid=6, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper", x=2.5, z=-6.75, y=-16.5, cellid=6, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper", x=7.9, z=-6.75, y=-16.9, cellid=6, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=8, z=-6.75, y=-6, cellid=7, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=3.6, z=-6.75, y=-8.8, cellid=7, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=3.6, z=-6.75, y=-.25, cellid=7, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper", x=-5.5, z=-13.75, y=-3, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_dark_trooper", x=.5, z=-13.75, y=-3, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_medic", x=.5, z=-13.75, y=-6.6, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_stormtrooper_medic", x=-5.5, z=-13.75, y=-6.6, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_imperial_medic", x=1.8, z=-13.75, y=-12.6, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_imperial_medic", x=-7.6, z=-13.75, y=-12.6, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="gcw_imperial_captain", x=-2.5, z=-13.75, y=-14.9, cellid=9, respawn=300, containmentType=-1, heading=0},
